#ifndef PROJECT_SETTINGS_RELEASE_H
#define PROJECT_SETTINGS_RELEASE_H

#if ((!defined DEBUG_DEVELOPMENT) || ((defined DEBUG_DEVELOPMENT) && (DEBUG_DEVELOPMENT != 1)))
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
/* ------------------------------------------------------------------- includes " " ------------------------------------------------------------------------- */
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
#include <Std_Types.h>

#ifndef PROJECT_SETTINGS_RELEASE_INFO_MSG
#define PROJECT_SETTINGS_RELEASE_INFO_MSG
#pragma message("Using project settings RELEASE")
#endif
...
#define PROJECT_SETTINGS_GLOBAL_DET_SWITCH                    (STD_OFF)
...
#define SYSTEM_BUILD_TYPE                       SYSTEM_BUILD_TYPE_RELEASE
 ...
 */
#define PROJECT_SETTINGS_RMBA_SWITCH                          (STD_OFF)
...
#endif /* ((!defined DEBUG_DEVELOPMENT) || ((defined DEBUG_DEVELOPMENT) && (DEBUG_DEVELOPMENT != 1))) */
#endif /* PROJECT_SETTINGS_RELEASE_H */
