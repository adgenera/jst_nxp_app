...
@if exist %BUILD_BASE_DIR%\..\..\log\LIB_CDD.build.log (
	copy /v %BUILD_BASE_DIR%\..\..\log\LIB_CDD.build.log %DEST_DIR%\
) else (
	echo %BUILD_BASE_DIR%\..\..\log\LIB_CDD.build.log NONEXISTENT
)
