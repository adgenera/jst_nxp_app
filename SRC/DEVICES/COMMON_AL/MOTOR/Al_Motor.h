...
// Timeout at 5 seconds on all devices
#define AL_MOTOR_CALIBRATION_TIMEOUT_THRESHOLD_UI16   (uint16) 50u
...
typedef enum
{
   ...
   AL_MOTOR_OPSUBSTATE_CALIB_FIRST_REWARD,
   AL_MOTOR_OPSUBSTATE_CALIB_SECOND_REWARD,
   AL_MOTOR_OPSUBSTATE_CALIB_SEARCH_ZERO,
