...
#define AL_MOTOR_STATECALIB_FIRSTBACK_UI16         (uint16)30 / 2
#define AL_MOTOR_STATECALIB_FIRSTFWD_UI16          (uint16)180 / 2
#define AL_MOTOR_STATECALIB_SECONDFWD_UI16         (uint16)216 / 2
