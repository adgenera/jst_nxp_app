...
static void Cdd_Motor_TriggerMotorStart (const Cdd_Motor_MotorNumberEnum motor_e)
{
   ...
   /* ****************************************************************************************** */
   if ((cdd_motor_Data_as[motor_e].stepModeChangeReq_e != CDD_MOTOR_STEPMODE_UNDEF)
   ...
   {      
      if(motor_e == CDD_MOTOR_MTR_HHSS){    	  
    	  ...
    	  update_Mtr_TimerCounterOverflowInterruptFp(&Cdd_Motor_RunMotorISR_MM);
...
void Cdd_Motor_SetStepMode (const Cdd_Motor_MotorNumberEnum motor_e, const Cdd_Motor_StepModeEnum stepMode_e)
{
            ...
            && (stepMode_e < CDD_MOTOR_STEPMODE_SIZE))
   {
      ...
      /* change step mode if necessary */
      if (((cdd_motor_Data_as[motor_e].isrIsRunning_ui8 == (uint8) FALSE) && (cdd_motor_Data_as[motor_e].currPosLevel0_ui8 == (uint8) 0u))
               || (cdd_motor_Data_as[motor_e].stepMode_e <= CDD_MOTOR_STEPMODE_STOP))
      {
         Cdd_Motor_ChangeStepModeConfig(motor_e);
      }
      else
...
Std_ReturnType Cdd_Motor_ZD_CalibrateZeroToWindow (const Cdd_Motor_MotorNumberEnum motor_e)
{
   ...
   if (
            (cdd_motor_zeroDetectionWindow_as[motor_e].rising_s.valid_ui8 != (uint8) TRUE)
            || (cdd_motor_zeroDetectionWindow_as[motor_e].falling_s.valid_ui8 != (uint8) TRUE)
            || (cdd_motor_zeroDetectionWindow_as[motor_e].rising_s.dir_e != CDD_MOTOR_DIR_FORWARD)
            || (cdd_motor_zeroDetectionWindow_as[motor_e].falling_s.dir_e != CDD_MOTOR_DIR_FORWARD)
   )
   {
      cdd_motor_zeroDetectionWindow_as[motor_e].rising_s.valid_ui8 = (uint8)FALSE;
      cdd_motor_zeroDetectionWindow_as[motor_e].falling_s.valid_ui8 = (uint8)FALSE;
   ...
   else
   {
      ...
      cdd_motor_Data_as[motor_e].currPosLevel1_ui32 =
            ((Cdd_Motor_Cfg_as[motor_e].uStepMaximumAbsolute_ui32 + cdd_motor_Data_as[motor_e].currPosLevel1_ui32) - zeroPositionAbsolute_ui32)
...
//}
 ...
 {	 
	...
	else if (cdd_motor_Data_as[CDD_MOTOR_MTR_HHSS].isrPeriodeCounter_ui16 == (uint16) 1u) /* c:7,5 */
	{
	   ...
	   /* change step mode if necessary */
	   // TODO: Be aware of speed ramp
	   if ((cdd_motor_Data_as[CDD_MOTOR_MTR_HHSS].stepModeChangeReq_e != CDD_MOTOR_STEPMODE_UNDEF)
	...
	*/
	...
	else if (cdd_motor_Data_as[CDD_MOTOR_MTR_MM].isrPeriodeCounter_ui16 == (uint16) 1u) /* c:7,5 */
	{
	   ...
	   /* change step mode if necessary */
	   // TODO: Be aware of speed ramp
	   if ((cdd_motor_Data_as[CDD_MOTOR_MTR_MM].stepModeChangeReq_e != CDD_MOTOR_STEPMODE_UNDEF)
