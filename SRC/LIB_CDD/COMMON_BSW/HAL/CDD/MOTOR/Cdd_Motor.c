...
static void Cdd_Motor_ChangeStepModeConfig(const Cdd_Motor_MotorNumberEnum motor_e);
...
static void Cdd_Motor_ApplyDirChangeAndGearPlayComp(const Cdd_Motor_MotorNumberEnum motor_e);
...
static void Cdd_Motor_ChangeStepModeConfig(const Cdd_Motor_MotorNumberEnum motor_e)
{
	cdd_motor_Data_as[motor_e].stepMode_e = cdd_motor_Data_as[motor_e].stepModeChangeReq_e;
	...
	{
		if (cdd_motor_Data_as[motor_e].stepMode_e == CDD_MOTOR_STEPMODE_MICRO_FAST)
		{
			cdd_motor_Data_as[motor_e].usedPatternCoil_0_ui16 = Cdd_Motor_Cfg_as[motor_e].coil_0_Fast_ui16;
			cdd_motor_Data_as[motor_e].usedPatternCoil_1_ui16 = Cdd_Motor_Cfg_as[motor_e].coil_1_Fast_ui16;
		}
		else if (cdd_motor_Data_as[motor_e].stepMode_e == CDD_MOTOR_STEPMODE_MICRO_SLOW)
		{
			cdd_motor_Data_as[motor_e].usedPatternCoil_0_ui16 = Cdd_Motor_Cfg_as[motor_e].coil_0_Slow_ui16;
			cdd_motor_Data_as[motor_e].usedPatternCoil_1_ui16 = Cdd_Motor_Cfg_as[motor_e].coil_1_Slow_ui16;
		}
		else
		{
			; /* do nothing */
		...
		{
			CDD_MOTOR_SET_DUTYCYCLE_COIL0_MTR1(cdd_motor_Data_as[motor_e].usedPatternCoil_0_ui16[cdd_motor_Data_as[motor_e].currPosLevel0_ui8]); /* c:8 */
			CDD_MOTOR_SET_DUTYCYCLE_COIL1_MTR1(cdd_motor_Data_as[motor_e].usedPatternCoil_1_ui16[cdd_motor_Data_as[motor_e].currPosLevel0_ui8]); /* c:8 */
		}
		else
		{
			CDD_MOTOR_SET_DUTYCYCLE_COIL0_MTR2(cdd_motor_Data_as[motor_e].usedPatternCoil_0_ui16[cdd_motor_Data_as[motor_e].currPosLevel0_ui8]); /* c:8 */
			CDD_MOTOR_SET_DUTYCYCLE_COIL1_MTR2(cdd_motor_Data_as[motor_e].usedPatternCoil_1_ui16[cdd_motor_Data_as[motor_e].currPosLevel0_ui8]); /* c:8 */
		}
...
static void Cdd_Motor_TriggerMotorStart(const Cdd_Motor_MotorNumberEnum motor_e)
{
	...
	/* ****************************************************************************************** */
	if ((cdd_motor_Data_as[motor_e].stepModeChangeReq_e != CDD_MOTOR_STEPMODE_UNDEF) && (cdd_motor_Data_as[motor_e].isrIsRunning_ui8 == (uint8)FALSE) && (cdd_motor_Data_as[motor_e].currPosLevel0_ui8 == (uint8)0u))
	{
...
static void Cdd_Motor_ApplyDirChangeAndGearPlayComp(const Cdd_Motor_MotorNumberEnum motor_e)
{
	if (cdd_motor_Data_as[motor_e].dirChangeReq_e != CDD_MOTOR_DIR_UNDEF)
	{
		...
		cdd_motor_Data_as[motor_e].dir_e = cdd_motor_Data_as[motor_e].dirChangeReq_e;
...
// #endif
//
//       cdd_motor_debounceRise_t.ctr_ui8 = (uint8)0U;
//       cdd_motor_debounceRise_t.dir_e = CDD_MOTOR_DIR_UNDEF;
//       cdd_motor_debounceRise_t.posAbsolute_ui32 = CDD_MOTOR_INVALID_POS_UI32;
//       cdd_motor_debounceFall_t.ctr_ui8 = (uint8)0U;
//       cdd_motor_debounceFall_t.dir_e = CDD_MOTOR_DIR_UNDEF;
//       cdd_motor_debounceFall_t.posAbsolute_ui32 = CDD_MOTOR_INVALID_POS_UI32;
//
//       cdd_motor_zeroDetectionWindow_t.rising_s.pos_ui32  = CDD_MOTOR_INVALID_POS_UI32;
//       cdd_motor_zeroDetectionWindow_t.rising_s.dir_e     = CDD_MOTOR_DIR_UNDEF;
//       cdd_motor_zeroDetectionWindow_t.rising_s.valid_ui8 = (uint8)FALSE;
//       cdd_motor_zeroDetectionWindow_t.falling_s.pos_ui32  = CDD_MOTOR_INVALID_POS_UI32;
//       cdd_motor_zeroDetectionWindow_t.falling_s.dir_e     = CDD_MOTOR_DIR_UNDEF;
//       cdd_motor_zeroDetectionWindow_t.falling_s.valid_ui8 = (uint8)FALSE;
//       cdd_motor_zeroDetectionWindow_t.lastResult_s.windowStart_ui32 = CDD_MOTOR_ZERO_POSITION_INVALID_UI32;
//       cdd_motor_zeroDetectionWindow_t.lastResult_s.windowEnd_ui32 = CDD_MOTOR_ZERO_POSITION_INVALID_UI32;
//       cdd_motor_zeroDetectionWindow_t.lastResult_s.windowSize_ui8 = CDD_MOTOR_ZERO_WIDTH_INVALID_UI8;
//       cdd_motor_zeroDetectionWindow_t.lastResult_s.windowSizeLeftMiddle_ui8 = CDD_MOTOR_ZERO_WIDTH_INVALID_UI8;
//       cdd_motor_zeroDetectionWindow_t.enabled_ui8 = (uint8)FALSE;
//       cdd_motor_zeroDetectionWindow_t.state_e = CDD_MOTOR_ZERO_DET_STATE_INITIAL;
//
//       cdd_motor_Data_t.currPosLevel0_ui8 = (uint8) 0u;
//       cdd_motor_Data_t.currPosLevel1_ui32 = (uint32) 0uL;
//       cdd_motor_Data_t.trgtPosLevel1_ui32 = (uint32) 0uL;
//       cdd_motor_Data_t.usedFullStep_e = CDD_MOTOR_USED_FSTEP_CTR_ABSOLUTE;
//
//       cdd_motor_Data_t.dir_e = CDD_MOTOR_DIR_FORWARD;
//       cdd_motor_Data_t.stepModeChangeReq_e = CDD_MOTOR_STEPMODE_UNDEF;
//
// #if (CDD_MOTOR_GEAR_PLAY_COMPENSATION_API == STD_ON)
//       cdd_motor_Data_t.gearPlayCompensation_ui8 = (uint8) 0u;
// #endif /* CDD_MOTOR_GEAR_PLAY_COMPENSATION_API == STD_ON */
//
//       cdd_motor_Data_t.usedUStepMaximum_pui32 = &Cdd_Motor_Cfg_t.uStepMaximumAbsolute_ui32;
//
//       cdd_motor_Data_t.stepMode_e = CDD_MOTOR_STEPMODE_MICRO_FAST;
//       cdd_motor_Data_t.usedPatternCoil_0_ui16 = Cdd_Motor_Cfg_t.coil_0_Fast_ui16;
//       cdd_motor_Data_t.usedPatternCoil_1_ui16 = Cdd_Motor_Cfg_t.coil_1_Fast_ui16;
//
// #if (CDD_MOTOR_GEAR_PLAY_COMPENSATION_API == STD_ON)
//       /* EEPROM: load gear play compensation for MTR */
//       rtn_e = Ea_Read(EA_GEAR_PLAY_COMP_MTR, &cdd_motor_Data_t.gearPlayCompensation_ui8);
// #if (CDD_MOTOR_DEV_ERROR_DETECT == STD_ON)
//       if (rtn_e != EA_OK)
//       {
...
//       (*((uint8* const) CDD_MOTOR_PTF_DATA_DIR_REG_ADR_UI16 )) |= (uint8) (0x1U << CDD_MOTOR_NO1_BITPOS_UI8);  /*lint !e923 */
//       /* Configure Port T 6 as input */
//       (*((uint8* const) CDD_MOTOR_PTT_DATA_DIR_REG_ADR_UI16 )) &= (uint8) (~((uint8)(0x1U << CDD_MOTOR_NO1_BITPOS_UI8)));  /*lint !e923 */
//       /* Set pull and polarity */
//       (*((uint8* const) CDD_MOTOR_PTT_PULL_EN_REG_ADR_UI16 )) |= (uint8) (0x1U << CDD_MOTOR_NO1_BITPOS_UI8);  /*lint !e923 */
//       (*((uint8* const) CDD_MOTOR_PTT_POL_SEL_REG_ADR_UI16 )) |= (uint8) (0x1U << CDD_MOTOR_NO1_BITPOS_UI8);  /*lint !e923 */
//
//
// #if (CDD_MOTOR_DEV_ERROR_DETECT == STD_ON)
...
void Cdd_Motor_Init(void)
{
...
#endif /* CDD_MOTOR_DEV_ERROR_DETECT == STD_ON */
	{
		...
		for (i_ui8 = (uint8)0U; i_ui8 < (uint8)CDD_MOTOR_MTR_NR_SIZE; i_ui8++)
		{
			cdd_motor_debounceRise_as[i_ui8].ctr_ui8 = (uint8)0U;
			cdd_motor_debounceRise_as[i_ui8].dir_e = CDD_MOTOR_DIR_UNDEF;
			cdd_motor_debounceRise_as[i_ui8].posAbsolute_ui32 = CDD_MOTOR_INVALID_POS_UI32;
			cdd_motor_debounceFall_as[i_ui8].ctr_ui8 = (uint8)0U;
			cdd_motor_debounceFall_as[i_ui8].dir_e = CDD_MOTOR_DIR_UNDEF;
			cdd_motor_debounceFall_as[i_ui8].posAbsolute_ui32 = CDD_MOTOR_INVALID_POS_UI32;

			cdd_motor_zeroDetectionWindow_as[i_ui8].rising_s.pos_ui32 = CDD_MOTOR_INVALID_POS_UI32;
			cdd_motor_zeroDetectionWindow_as[i_ui8].rising_s.dir_e = CDD_MOTOR_DIR_UNDEF;
			cdd_motor_zeroDetectionWindow_as[i_ui8].rising_s.valid_ui8 = (uint8)FALSE;
			cdd_motor_zeroDetectionWindow_as[i_ui8].falling_s.pos_ui32 = CDD_MOTOR_INVALID_POS_UI32;
			cdd_motor_zeroDetectionWindow_as[i_ui8].falling_s.dir_e = CDD_MOTOR_DIR_UNDEF;
			cdd_motor_zeroDetectionWindow_as[i_ui8].falling_s.valid_ui8 = (uint8)FALSE;
			cdd_motor_zeroDetectionWindow_as[i_ui8].lastResult_s.windowStart_ui32 = CDD_MOTOR_ZERO_POSITION_INVALID_UI32;
			cdd_motor_zeroDetectionWindow_as[i_ui8].lastResult_s.windowEnd_ui32 = CDD_MOTOR_ZERO_POSITION_INVALID_UI32;
			cdd_motor_zeroDetectionWindow_as[i_ui8].lastResult_s.windowSize_ui8 = CDD_MOTOR_ZERO_WIDTH_INVALID_UI8;
			cdd_motor_zeroDetectionWindow_as[i_ui8].lastResult_s.windowSizeLeftMiddle_ui8 = CDD_MOTOR_ZERO_WIDTH_INVALID_UI8;
			cdd_motor_zeroDetectionWindow_as[i_ui8].enabled_ui8 = (uint8)FALSE;
			cdd_motor_zeroDetectionWindow_as[i_ui8].state_e = CDD_MOTOR_ZERO_DET_STATE_INITIAL;
			...
			cdd_motor_Data_as[i_ui8].usedFullStep_e = CDD_MOTOR_USED_FSTEP_CTR_ABSOLUTE;

			cdd_motor_Data_as[i_ui8].dir_e = CDD_MOTOR_DIR_FORWARD;
			cdd_motor_Data_as[i_ui8].stepModeChangeReq_e = CDD_MOTOR_STEPMODE_UNDEF;
		}
		...
		cdd_motor_Data_as[CDD_MOTOR_MTR_HHSS].usedUStepMaximum_pui32 = &Cdd_Motor_Cfg_as[CDD_MOTOR_MTR_HHSS].uStepMaximumAbsolute_ui32;

		cdd_motor_Data_as[CDD_MOTOR_MTR_HHSS].stepMode_e = CDD_MOTOR_STEPMODE_MICRO_FAST;
		cdd_motor_Data_as[CDD_MOTOR_MTR_HHSS].usedPatternCoil_0_ui16 = Cdd_Motor_Cfg_as[CDD_MOTOR_MTR_HHSS].coil_0_Fast_ui16;
		cdd_motor_Data_as[CDD_MOTOR_MTR_HHSS].usedPatternCoil_1_ui16 = Cdd_Motor_Cfg_as[CDD_MOTOR_MTR_HHSS].coil_1_Fast_ui16;
		...
		cdd_motor_Data_as[CDD_MOTOR_MTR_MM].usedUStepMaximum_pui32 = &Cdd_Motor_Cfg_as[CDD_MOTOR_MTR_MM].uStepMaximumAbsolute_ui32;

		cdd_motor_Data_as[CDD_MOTOR_MTR_MM].stepMode_e = CDD_MOTOR_STEPMODE_MICRO_FAST;
		cdd_motor_Data_as[CDD_MOTOR_MTR_MM].usedPatternCoil_0_ui16 = Cdd_Motor_Cfg_as[CDD_MOTOR_MTR_MM].coil_0_Fast_ui16;
		cdd_motor_Data_as[CDD_MOTOR_MTR_MM].usedPatternCoil_1_ui16 = Cdd_Motor_Cfg_as[CDD_MOTOR_MTR_MM].coil_1_Fast_ui16;
		...
		// TODO COMPASS: -> PORT CFG
		/* Configure Port F 6 as output */
		(*((uint8 *const)CDD_MOTOR_PTF_DATA_DIR_REG_ADR_UI16)) |= (uint8)(0x1U << CDD_MOTOR_NO2_BITPOS_UI8); /*lint !e923 */
		/* Configure Port T 6 as input */
		(*((uint8 *const)CDD_MOTOR_PTT_DATA_DIR_REG_ADR_UI16)) &= (uint8)(~((uint8)(0x1U << CDD_MOTOR_NO2_BITPOS_UI8))); /*lint !e923 */
		/* Set pull and polarity */
		(*((uint8 *const)CDD_MOTOR_PTT_PULL_EN_REG_ADR_UI16)) |= (uint8)(0x1U << CDD_MOTOR_NO2_BITPOS_UI8); /*lint !e923 */
		(*((uint8 *const)CDD_MOTOR_PTT_POL_SEL_REG_ADR_UI16)) |= (uint8)(0x1U << CDD_MOTOR_NO2_BITPOS_UI8); /*lint !e923 */
#else
		// HHSS
		/* Load gear play compensation for MTR HHSS from EEPROM */
 ...
 *
 */
// Std_ReturnType Cdd_Motor_SetSpeedFac (const Cdd_Motor_SpeedEnum targetSpeed_e)
//{
//    Std_ReturnType rtn_e = (uint8) E_NOT_OK;
//
//    if (targetSpeed_e < CDD_MOTOR_NBR_OF_SPEEDS)
//    {
//       cdd_motor_Data_t.isrTargetNbrOfPeriodes_ui16 = targetSpeed_e;
//       rtn_e = (uint8) E_OK;
//    }
//    return rtn_e;
// }
 ...
 *
 */
// void Cdd_Motor_ChangeDefaultFullStepCounter (const Cdd_Motor_UsedFullStepModeEnum counterTyp_e)
//{
//    /* THIS SEQUENCE MAY NOT BE INTERRUPTED ********************************** */
//    DISABLE_ALL_INTERRUPTS(); /*lint !e960 */
//    if (counterTyp_e == CDD_MOTOR_USED_FSTEP_CTR_RELATIVE)
//    {
//       cdd_motor_Data_t.usedUStepMaximum_pui32 = &Cdd_Motor_Cfg_t.uStepMaximumRelative_ui32;
//       cdd_motor_Data_t.usedFullStep_e = counterTyp_e;
//    }
//    else
//    {
//       cdd_motor_Data_t.usedUStepMaximum_pui32 = &Cdd_Motor_Cfg_t.uStepMaximumAbsolute_ui32;
...
void Cdd_Motor_ChangeDefaultFullStepCounter(const Cdd_Motor_MotorNumberEnum motor_e, const Cdd_Motor_UsedFullStepModeEnum counterTyp_e)
{
	...
	if (counterTyp_e == CDD_MOTOR_USED_FSTEP_CTR_RELATIVE)
	{
		cdd_motor_Data_as[motor_e].usedUStepMaximum_pui32 = &Cdd_Motor_Cfg_as[motor_e].uStepMaximumRelative_ui32;
		cdd_motor_Data_as[motor_e].usedFullStep_e = counterTyp_e;
	}
	else
	{
		cdd_motor_Data_as[motor_e].usedUStepMaximum_pui32 = &Cdd_Motor_Cfg_as[motor_e].uStepMaximumAbsolute_ui32;
		cdd_motor_Data_as[motor_e].usedFullStep_e = CDD_MOTOR_USED_FSTEP_CTR_ABSOLUTE;
	}
	ENABLE_ALL_INTERRUPTS(); /*lint !e960 */
							 /* END OF UNINTERRUPTABLE SEQUENCE *************************************** */
}

// void Cdd_Motor_StopPWM (void)
//{
//    /* THIS SEQUENCE MAY NOT BE INTERRUPTED ********************************** */
//    DISABLE_ALL_INTERRUPTS(); /*lint !e960 */
//    /* Set duty cycle ********************************************************************* */
//    CDD_MOTOR_SET_DUTYCYCLE_COIL0 ((Mtr_ChannelDutyCycleType) 0U);
//    CDD_MOTOR_SET_DUTYCYCLE_COIL1 ((Mtr_ChannelDutyCycleType) 0U);
//    CDD_MOTOR_DISABLE_COIL0();
//    CDD_MOTOR_DISABLE_COIL1();
//    ENABLE_ALL_INTERRUPTS(); /*lint !e960 */
//    /* END OF UNINTERRUPTABLE SEQUENCE *************************************** */
//
//    cdd_motor_Data_t.isrIsRunning_ui8 = (uint8) FALSE;
// }
 ...
 * \return      ---
 */
// Cdd_Motor_StepModeEnum Cdd_Motor_GetStepMode (void)
//{
//    return cdd_motor_Data_t.stepMode_e;
// }
 ...
 * \return      ---
 */
// void Cdd_Motor_SetStepMode (const Cdd_Motor_StepModeEnum stepMode_e)
//{
//    if ((stepMode_e > CDD_MOTOR_STEPMODE_UNDEF)
//             && (stepMode_e < CDD_MOTOR_STEPMODE_SIZE))
//    {
//       cdd_motor_Data_t.stepModeChangeReq_e = stepMode_e;
//
//       /* change step mode if necessary */
//       if (((cdd_motor_Data_t.isrIsRunning_ui8 == (uint8) FALSE) && (cdd_motor_Data_t.currPosLevel0_ui8 == (uint8) 0u))
//                || (cdd_motor_Data_t.stepMode_e <= CDD_MOTOR_STEPMODE_STOP))
//       {
//          Cdd_Motor_ChangeStepModeConfig ();
//       }
//       else
//       {
//          ; /* do nothing */
...
{
	if ((stepMode_e > CDD_MOTOR_STEPMODE_UNDEF) && (stepMode_e < CDD_MOTOR_STEPMODE_SIZE))
	{
		cdd_motor_Data_as[motor_e].stepModeChangeReq_e = stepMode_e;

		/* change step mode if necessary */
		if (((cdd_motor_Data_as[motor_e].isrIsRunning_ui8 == (uint8)FALSE) && (cdd_motor_Data_as[motor_e].currPosLevel0_ui8 == (uint8)0u)) || (cdd_motor_Data_as[motor_e].stepMode_e <= CDD_MOTOR_STEPMODE_STOP))
		{
			Cdd_Motor_ChangeStepModeConfig(motor_e);
		}
		else
 ...
 * \return      ---
 */
// void Cdd_Motor_SetDirectionReq (const Cdd_Motor_DirectionEnum dir_e)
//{
//    if ((CDD_MOTOR_DIR_UNDEF < dir_e) && (CDD_MOTOR_DIR_SIZE > dir_e))
//    {
//       if (cdd_motor_Data_t.dir_e != dir_e)
//       {
//          cdd_motor_Data_t.dirChangeReq_e = dir_e;
//       }
//       else
//       {
//          cdd_motor_Data_t.dirChangeReq_e = CDD_MOTOR_DIR_UNDEF;
//       }
//    }
//    else
//    {
 ...
 * \return      ---
 */
// Cdd_Motor_DirectionEnum Cdd_Motor_GetDirection (void)
//{
//    return cdd_motor_Data_t.dir_e;
// }
 ...
 * \return      ---
 */
// uint8 Cdd_Motor_GetUStepPosition (void)
//{
//    uint8 partpos_ui8;
//
//    partpos_ui8 = cdd_motor_Data_t.currPosLevel0_ui8;
//
//    return partpos_ui8;
// }
 ...
 * \return      ---
 */
// void Cdd_Motor_RunToFullStepPosition (const uint16 pos_ui16)
//{
//    uint32 destPos_ui32 = (uint32)0UL;
//
//    destPos_ui32 = (uint32)((uint32)pos_ui16 * (uint32)CDD_MOTOR_MICRO_STEPS_ARRAY_SIZE);
//
//    Cdd_Motor_RunToPosition (destPos_ui32);
// }

void Cdd_Motor_RunToFullStepPosition(const Cdd_Motor_MotorNumberEnum motor_e, const uint16 pos_ui16)
{
	uint32 destPos_ui32 = (uint32)0UL;
 ...
 * \return      ---
 */
// void Cdd_Motor_RunToPosition (const uint32 newTarget_ui32)
//{
//    uint32 destPos_ui32 = (uint32) 0uL;
...
//    if (newTarget_ui32 >= *(cdd_motor_Data_t.usedUStepMaximum_pui32))
//    {
//       normalizedTarget_ui32 = newTarget_ui32 % *(cdd_motor_Data_t.usedUStepMaximum_pui32);
//    }
//    else
//    {
...
//    }
//
//    if (cdd_motor_Data_t.dirChangeReq_e != CDD_MOTOR_DIR_UNDEF)
//    {
//       calcDir_e = cdd_motor_Data_t.dirChangeReq_e;
//    }
//    else
//    {
//       calcDir_e = cdd_motor_Data_t.dir_e;
//    }
//
//    /* THIS SEQUENCE MAY NOT BE INTERRUPTED ********************************** */
//    DISABLE_ALL_INTERRUPTS(); /*lint !e960 */
//
//    if (cdd_motor_Data_t.usedFullStep_e == CDD_MOTOR_USED_FSTEP_CTR_RELATIVE)
//    {
//       uint32 relPos_ui32;
//       uint32 fullRoundPos_ui32;
//
//       /* normalise current position */
//       relPos_ui32 = cdd_motor_Data_t.currPosLevel1_ui32 % *(cdd_motor_Data_t.usedUStepMaximum_pui32);
//       fullRoundPos_ui32 = cdd_motor_Data_t.currPosLevel1_ui32 - relPos_ui32;
//
...
//          else
//          {
//             destPos_ui32 = fullRoundPos_ui32 + *(cdd_motor_Data_t.usedUStepMaximum_pui32) + normalizedTarget_ui32;
//          }
//       }
...
//             {
//                fullRoundPos_ui32 = Cdd_Motor_Cfg_t.uStepMaximumAbsolute_ui32;
//             }
//             else
//             {
//                ; /* do nothing */
...
//       destPos_ui32 %= Cdd_Motor_Cfg_t.uStepMaximumAbsolute_ui32;
//    }
//    else
//    {
...
//
// #if 0
//    if (destPos_ui32 != cdd_motor_Data_t.currPosLevel1_ui32)
//    {
// #endif
//       /* Apply direction change request if required */
//       /* TODO COMPASS: AUFPASSEN */
//       Cdd_Motor_ApplyDirChangeAndGearPlayComp ();
// #if 0
//    }
// #endif
//
//    /* set new target position */
//    cdd_motor_Data_t.trgtPosLevel1_ui32 = destPos_ui32;
//
//    ENABLE_ALL_INTERRUPTS(); /*lint !e960 */
//    /* END OF UNINTERRUPTABLE SEQUENCE *************************************** */
//
//    /* Start motor if not already happened */
//    Cdd_Motor_TriggerMotorStart();
// }

void Cdd_Motor_RunToPosition(const Cdd_Motor_MotorNumberEnum motor_e, const uint32 newTarget_ui32)
{
	uint32 destPos_ui32 = (uint32)0uL;
	uint32 normalizedTarget_ui32;
	Cdd_Motor_DirectionEnum calcDir_e;
	...
	/* normalise input vector */
	if (newTarget_ui32 >= *(cdd_motor_Data_as[motor_e].usedUStepMaximum_pui32))
	{
		normalizedTarget_ui32 = newTarget_ui32 % *(cdd_motor_Data_as[motor_e].usedUStepMaximum_pui32);
	}
	else
	{
		normalizedTarget_ui32 = newTarget_ui32;
	...
	if (cdd_motor_Data_as[motor_e].usedFullStep_e == CDD_MOTOR_USED_FSTEP_CTR_RELATIVE)
	{
		uint32 relPos_ui32;
		uint32 fullRoundPos_ui32;

		/* normalise current position */
		relPos_ui32 = cdd_motor_Data_as[motor_e].currPosLevel1_ui32 % *(cdd_motor_Data_as[motor_e].usedUStepMaximum_pui32);
		fullRoundPos_ui32 = cdd_motor_Data_as[motor_e].currPosLevel1_ui32 - relPos_ui32;
		...
		if (calcDir_e == CDD_MOTOR_DIR_FORWARD)
		{
			...
			{
				destPos_ui32 = fullRoundPos_ui32 + *(cdd_motor_Data_as[motor_e].usedUStepMaximum_pui32) + normalizedTarget_ui32;
			}
		}
		else if (calcDir_e == CDD_MOTOR_DIR_BACKWARD)
		{
			...
			else
			{
				if (fullRoundPos_ui32 == (uint32)0uL)
				{
					fullRoundPos_ui32 = Cdd_Motor_Cfg_as[motor_e].uStepMaximumAbsolute_ui32;
				}
				else
				{
					; /* do nothing */
 ...
 * \return      ---
 */
// void Cdd_Motor_RunToPositionAbsolute(const uint32 absolutposition_ui32)
//{
//    /* THIS SEQUENCE MAY NOT BE INTERRUPTED ********************************** */
//    DISABLE_ALL_INTERRUPTS(); /*lint !e960 */
//
// #if 0
//    if (absolutposition_ui32 != cdd_motor_Data_t.currPosLevel1_ui32)
//    {
// #endif
//       /* Apply direction change request if required */
//       /* TODO COMPASS: AUFPASSEN */
...
// #endif
//
//    if (absolutposition_ui32 >= *(cdd_motor_Data_t.usedUStepMaximum_pui32))
//    {
//       cdd_motor_Data_t.trgtPosLevel1_ui32 = absolutposition_ui32 % (*(cdd_motor_Data_t.usedUStepMaximum_pui32));
//    }
//    else
//    {
//       cdd_motor_Data_t.trgtPosLevel1_ui32 = absolutposition_ui32;
//    }
//
//    ENABLE_ALL_INTERRUPTS(); /*lint !e960 */
//    /* END OF UNINTERRUPTABLE SEQUENCE *************************************** */
...
void Cdd_Motor_RunToPositionAbsolute(const Cdd_Motor_MotorNumberEnum motor_e, const uint32 absolutposition_ui32)
{
	/* THIS SEQUENCE MAY NOT BE INTERRUPTED ********************************** */
	DISABLE_ALL_INTERRUPTS(); /*lint !e960 */
   ...
   if (absolutposition_ui32 != cdd_motor_Data_as[motor_e].currPosLevel1_ui32)
   {
	...
	if (absolutposition_ui32 >= *(cdd_motor_Data_as[motor_e].usedUStepMaximum_pui32))
	{
		cdd_motor_Data_as[motor_e].trgtPosLevel1_ui32 = absolutposition_ui32 % (*(cdd_motor_Data_as[motor_e].usedUStepMaximum_pui32));
	}
	else
	{
 ...
 * \return      ---
 */
// void Cdd_Motor_RunDistanceFullSteps (const uint16 position_ui16)
//{
//    Cdd_Motor_RunDistance (CDD_MOTOR_DIR_UNDEF, position_ui16, (uint8) 0u);
// }

void Cdd_Motor_RunDistanceFullSteps(const Cdd_Motor_MotorNumberEnum motor_e, const uint16 position_ui16)
{
	Cdd_Motor_RunDistance(motor_e, CDD_MOTOR_DIR_UNDEF, position_ui16, (uint8)0u);
}
 ...
 * \return      ---
 */
// void Cdd_Motor_RunDistance (const Cdd_Motor_DirectionEnum dir_e, const uint16 fStep_ui16, const uint8 uStep_ui8)
//{
//    uint32 distance_ui32 = (uint32)0UL;
//
//    distance_ui32 = (((uint32) fStep_ui16) * ((uint32) CDD_MOTOR_MICRO_STEPS_ARRAY_SIZE)) + (uint32)uStep_ui8;
//
//    Cdd_Motor_SetDirectionReq (dir_e);
//
//    if (distance_ui32 >= Cdd_Motor_Cfg_t.uStepMaximumAbsolute_ui32)
//    {
//       distance_ui32 %= Cdd_Motor_Cfg_t.uStepMaximumAbsolute_ui32;
//    }
//
...
//
//
//    if (CDD_MOTOR_DIR_FORWARD == cdd_motor_Data_t.dir_e)
//    {
//       cdd_motor_Data_t.trgtPosLevel1_ui32 += distance_ui32;
//    }
//    else if (CDD_MOTOR_DIR_BACKWARD == cdd_motor_Data_t.dir_e)
//    {
//       if (cdd_motor_Data_t.trgtPosLevel1_ui32 >= distance_ui32)
//       {
//          cdd_motor_Data_t.trgtPosLevel1_ui32 -= distance_ui32;
//       }
//       else
//       {
//          cdd_motor_Data_t.trgtPosLevel1_ui32 += (Cdd_Motor_Cfg_t.uStepMaximumAbsolute_ui32 - distance_ui32);
//       }
//    }
//    else
//    {
...
//    }
//
//    if (cdd_motor_Data_t.trgtPosLevel1_ui32 >= Cdd_Motor_Cfg_t.uStepMaximumAbsolute_ui32)
//    {
//       cdd_motor_Data_t.trgtPosLevel1_ui32 %= Cdd_Motor_Cfg_t.uStepMaximumAbsolute_ui32;
//    }
//
//    ENABLE_ALL_INTERRUPTS(); /*lint !e960 */
//    /* END OF UNINTERRUPTABLE SEQUENCE *************************************** */
...
void Cdd_Motor_RunDistance(const Cdd_Motor_MotorNumberEnum motor_e, const Cdd_Motor_DirectionEnum dir_e, const uint16 fStep_ui16, const uint8 uStep_ui8)
{
	...
	else if (CDD_MOTOR_DIR_BACKWARD == cdd_motor_Data_as[motor_e].dir_e)
	{
		...
		{
			cdd_motor_Data_as[motor_e].trgtPosLevel1_ui32 += (Cdd_Motor_Cfg_as[motor_e].uStepMaximumAbsolute_ui32 - distance_ui32);
		}
	}
	else
	{
	...
	if (cdd_motor_Data_as[motor_e].trgtPosLevel1_ui32 >= Cdd_Motor_Cfg_as[motor_e].uStepMaximumAbsolute_ui32)
	{
		cdd_motor_Data_as[motor_e].trgtPosLevel1_ui32 %= Cdd_Motor_Cfg_as[motor_e].uStepMaximumAbsolute_ui32;
	}
 ...
 * \return      ---
 */
// void Cdd_Motor_RunToNextFullStep (void)
//{
//    uint32 destPos_ui32 = (uint32) 0uL;
...
//    Cdd_Motor_ApplyDirChangeAndGearPlayComp ();
//
//    curPos_ui32 = cdd_motor_Data_t.currPosLevel1_ui32;
//    currPartStep_ui16 = (uint16)(curPos_ui32 % (uint32)CDD_MOTOR_MICRO_STEPS_ARRAY_SIZE);
//
//    if (cdd_motor_Data_t.dir_e == CDD_MOTOR_DIR_FORWARD)
//    {
//       uint16 diffPartStep_ui16 = (uint16) 0u;
//       diffPartStep_ui16 = (((uint16)CDD_MOTOR_MICRO_STEPS_ARRAY_SIZE) - currPartStep_ui16);
//
//       destPos_ui32 = curPos_ui32 + (uint32)diffPartStep_ui16;
//
//       if (destPos_ui32 >= Cdd_Motor_Cfg_t.uStepMaximumAbsolute_ui32)
//       {
//          destPos_ui32 %= Cdd_Motor_Cfg_t.uStepMaximumAbsolute_ui32;
//       }
//       cdd_motor_Data_t.trgtPosLevel1_ui32 = destPos_ui32;
//    }
//    else if (cdd_motor_Data_t.dir_e == CDD_MOTOR_DIR_BACKWARD)
//    {
//       /* Cannot become negative */
//       cdd_motor_Data_t.trgtPosLevel1_ui32 = curPos_ui32 - (uint32)currPartStep_ui16;
//    }
//    else
//    {
//       ; /* do nothing */
...
void Cdd_Motor_RunToNextFullStep(const Cdd_Motor_MotorNumberEnum motor_e)
{
	...
	if (cdd_motor_Data_as[motor_e].dir_e == CDD_MOTOR_DIR_FORWARD)
	{
		...
		if (destPos_ui32 >= Cdd_Motor_Cfg_as[motor_e].uStepMaximumAbsolute_ui32)
		{
			destPos_ui32 %= Cdd_Motor_Cfg_as[motor_e].uStepMaximumAbsolute_ui32;
		}
		cdd_motor_Data_as[motor_e].trgtPosLevel1_ui32 = destPos_ui32;
	...
	{
		/* Cannot become negative */
		cdd_motor_Data_as[motor_e].trgtPosLevel1_ui32 = curPos_ui32 - (uint32)currPartStep_ui16;
	}
	else
	{
		; /* do nothing */
...
uint8 Cdd_Motor_GetPartStepPosition(const Cdd_Motor_MotorNumberEnum motor_e)
{
	...
	/* THIS SEQUENCE MAY NOT BE INTERRUPTED ********************************** */
	DISABLE_ALL_INTERRUPTS(); /*lint !e960 */
	partpos_ui8 = (uint8)(cdd_motor_Data_as[motor_e].currPosLevel1_ui32 % (uint32)CDD_MOTOR_MICRO_STEPS_ARRAY_SIZE);
	ENABLE_ALL_INTERRUPTS(); /*lint !e960 */
	/* END OF UNINTERRUPTABLE SEQUENCE *************************************** */
...
uint16 Cdd_Motor_GetFullStepPositionUsed(const Cdd_Motor_MotorNumberEnum motor_e)
{
	...
	/* THIS SEQUENCE MAY NOT BE INTERRUPTED ********************************** */
	DISABLE_ALL_INTERRUPTS(); /*lint !e960 */
	currPos_ui16 = (uint16)(cdd_motor_Data_as[motor_e].currPosLevel1_ui32 / (uint32)CDD_MOTOR_MICRO_STEPS_ARRAY_SIZE);
	ENABLE_ALL_INTERRUPTS(); /*lint !e960 */
	/* END OF UNINTERRUPTABLE SEQUENCE *************************************** */

	if (cdd_motor_Data_as[motor_e].usedFullStep_e == CDD_MOTOR_USED_FSTEP_CTR_RELATIVE)
	{
		currPos_ui16 = (uint16)((uint32)currPos_ui16 % *(cdd_motor_Data_as[motor_e].usedUStepMaximum_pui32));
	}
	else
	{
		; /* nothing to do */
...
uint32 Cdd_Motor_GetPositionCurrentUsed(const Cdd_Motor_MotorNumberEnum motor_e)
{
	...
	/* THIS SEQUENCE MAY NOT BE INTERRUPTED ********************************** */
	DISABLE_ALL_INTERRUPTS(); /*lint !e960 */
	currPos_ui32 = (uint32)(cdd_motor_Data_as[motor_e].currPosLevel1_ui32 % *(cdd_motor_Data_as[motor_e].usedUStepMaximum_pui32));
	ENABLE_ALL_INTERRUPTS(); /*lint !e960 */
	/* END OF UNINTERRUPTABLE SEQUENCE *************************************** */
...
uint32 Cdd_Motor_GetPositionTargetUsed(const Cdd_Motor_MotorNumberEnum motor_e)
{
	...
	DISABLE_ALL_INTERRUPTS();
	/*lint !e960 */
	target_ui32 = cdd_motor_Data_as[motor_e].trgtPosLevel1_ui32 % *(cdd_motor_Data_as[motor_e].usedUStepMaximum_pui32);
	ENABLE_ALL_INTERRUPTS();
	/*lint !e960 */
	/* END OF UNINTERRUPTABLE SEQUENCE *************************************** */
...
uint8 Cdd_Motor_GetPartStepTarget(const Cdd_Motor_MotorNumberEnum motor_e)
{
	...
	/* THIS SEQUENCE MAY NOT BE INTERRUPTED ********************************** */
	DISABLE_ALL_INTERRUPTS(); /*lint !e960 */
	partpos_ui8 = (uint8)(cdd_motor_Data_as[motor_e].trgtPosLevel1_ui32 % (uint32)CDD_MOTOR_MICRO_STEPS_ARRAY_SIZE);
	ENABLE_ALL_INTERRUPTS(); /*lint !e960 */
	/* END OF UNINTERRUPTABLE SEQUENCE *************************************** */
...
uint16 Cdd_Motor_GetFullStepTargetUsed(const Cdd_Motor_MotorNumberEnum motor_e)
{
	...
	/* THIS SEQUENCE MAY NOT BE INTERRUPTED ********************************** */
	DISABLE_ALL_INTERRUPTS(); /*lint !e960 */
	currPos_ui16 = (uint16)(cdd_motor_Data_as[motor_e].trgtPosLevel1_ui32 / (uint32)CDD_MOTOR_MICRO_STEPS_ARRAY_SIZE);
	ENABLE_ALL_INTERRUPTS(); /*lint !e960 */
	/* END OF UNINTERRUPTABLE SEQUENCE *************************************** */
...
uint8 Cdd_Motor_ReachedFinalPosition(const Cdd_Motor_MotorNumberEnum motor_e)
{
	...
	/* THIS SEQUENCE MAY NOT BE INTERRUPTED ********************************** */
	DISABLE_ALL_INTERRUPTS(); /*lint !e960 */
	if (cdd_motor_Data_as[motor_e].usedFullStep_e == CDD_MOTOR_USED_FSTEP_CTR_ABSOLUTE)
	{
		if (cdd_motor_Data_as[motor_e].currPosLevel1_ui32 == cdd_motor_Data_as[motor_e].trgtPosLevel1_ui32)
		{
			ret_t = (uint8)TRUE;
		}
		else
	...
	{
		uint32 current_ui32 = cdd_motor_Data_as[motor_e].currPosLevel1_ui32 % *(cdd_motor_Data_as[motor_e].usedUStepMaximum_pui32);
		uint32 target_ui32 = cdd_motor_Data_as[motor_e].trgtPosLevel1_ui32 % *(cdd_motor_Data_as[motor_e].usedUStepMaximum_pui32);
...
void Cdd_Motor_ZD_PerformWindowCheck(const Cdd_Motor_MotorNumberEnum motor_e)
{
	...
	if (CDD_MOTOR_ZERO_DET_STATE_DETECTION_VALIDATE == cdd_motor_zeroDetectionWindow_as[motor_e].state_e)
	{
		/* Runtime calibration */
	...
	if (CDD_MOTOR_ZERO_DET_STATE_DETECTION_VALIDATE <= cdd_motor_zeroDetectionWindow_as[motor_e].state_e)
	{
		...
		cdd_motor_zeroDetectionWindow_as[motor_e].rising_s.pos_ui32 = CDD_MOTOR_INVALID_POS_UI32;
		cdd_motor_zeroDetectionWindow_as[motor_e].rising_s.dir_e = CDD_MOTOR_DIR_UNDEF;
		cdd_motor_zeroDetectionWindow_as[motor_e].rising_s.valid_ui8 = (uint8)FALSE;
		cdd_motor_zeroDetectionWindow_as[motor_e].falling_s.pos_ui32 = CDD_MOTOR_INVALID_POS_UI32;
		cdd_motor_zeroDetectionWindow_as[motor_e].falling_s.dir_e = CDD_MOTOR_DIR_UNDEF;
		...
		cdd_motor_debounceRise_as[motor_e].posAbsolute_ui32 = CDD_MOTOR_INVALID_POS_UI32;
		cdd_motor_debounceFall_as[motor_e].ctr_ui8 = (uint8)0U;
		cdd_motor_debounceFall_as[motor_e].dir_e = CDD_MOTOR_DIR_UNDEF;
		cdd_motor_debounceFall_as[motor_e].posAbsolute_ui32 = CDD_MOTOR_INVALID_POS_UI32;

		cdd_motor_zeroDetectionWindow_as[motor_e].state_e = CDD_MOTOR_ZERO_DET_STATE_INITIAL;
	}
	else
	{
...
void Cdd_Motor_ZD_CalibrateZeroToActivePosition(const Cdd_Motor_MotorNumberEnum motor_e)
{
	...
	usteps_ui32 = cdd_motor_Data_as[motor_e].currPosLevel1_ui32 % ((uint32)CDD_MOTOR_MICRO_STEPS_ARRAY_SIZE);
...
Std_ReturnType Cdd_Motor_ZD_CalibrateZeroToWindow(const Cdd_Motor_MotorNumberEnum motor_e)
{
	...
	if (
		(cdd_motor_zeroDetectionWindow_as[motor_e].rising_s.valid_ui8 != (uint8)TRUE) || (cdd_motor_zeroDetectionWindow_as[motor_e].falling_s.valid_ui8 != (uint8)TRUE) || (cdd_motor_zeroDetectionWindow_as[motor_e].rising_s.dir_e != CDD_MOTOR_DIR_FORWARD) || (cdd_motor_zeroDetectionWindow_as[motor_e].falling_s.dir_e != CDD_MOTOR_DIR_FORWARD))
	{
		cdd_motor_zeroDetectionWindow_as[motor_e].rising_s.valid_ui8 = (uint8)FALSE;
		cdd_motor_zeroDetectionWindow_as[motor_e].falling_s.valid_ui8 = (uint8)FALSE;
	...
	if (cdd_motor_zeroDetectionWindow_as[motor_e].rising_s.dir_e == CDD_MOTOR_DIR_BACKWARD)
	{
		uint32 exchangePos_ui32;

		exchangePos_ui32 = cdd_motor_zeroDetectionWindow_as[motor_e].rising_s.pos_ui32;
		cdd_motor_zeroDetectionWindow_as[motor_e].rising_s.pos_ui32 = cdd_motor_zeroDetectionWindow_as[motor_e].falling_s.pos_ui32;
		cdd_motor_zeroDetectionWindow_as[motor_e].falling_s.pos_ui32 = exchangePos_ui32;
	}
	else
	{
		/* do nothing */
	...
	secondpos_ui32 = cdd_motor_zeroDetectionWindow_as[motor_e].falling_s.pos_ui32;
	...
	/* Store window width */
	partStep1st_ui32 = cdd_motor_zeroDetectionWindow_as[motor_e].rising_s.pos_ui32 % (uint32)CDD_MOTOR_MICRO_STEPS_ARRAY_SIZE;

	windowSize_ui8 = (uint8)(secondpos_ui32 - firstpos_ui32);
	windowSizeLeftMiddle_ui8 = (uint8)((uint32)CDD_MOTOR_MICRO_STEPS_ARRAY_SIZE - partStep1st_ui32);
 ...
 * \return      ---
 */
// void Cdd_Motor_ZD_EnableDetection (void)
//{
//    /* Set Port F 6 output to high */
//    *((uint8* const) CDD_MOTOR_PTF_DATA_REG_ADR_UI16 ) |= (uint8) (0x1U << CDD_MOTOR_NO1_BITPOS_UI8);  /*lint !e923 */
// #if 0
//    Dio_WriteChannel(DIO_CHANNEL_PU7, DIO_LEVEL_LOW);
// #endif
//
//    /* Do not enable zero detection if it was already enabled */
//    if (cdd_motor_zeroDetectionWindow_t.enabled_ui8 != (uint8)TRUE)
//    {
//       cdd_motor_zeroDetectionWindow_t.enabled_ui8 = (uint8)TRUE;
//       cdd_motor_zeroDetectionWindow_t.state_e = CDD_MOTOR_ZERO_DET_STATE_INITIAL;
//    }
//    else
//    {
 ...
 * \return      ---
 */
/* \req #CS_REQ_000063 - If the temperature limits are not over taken, the software shall enable the "zero detection" digital outputs for hour/minute and seconds pointer */
// void Cdd_Motor_ZD_DisableDetection (void)
//{
//    /* Set Port F 6 output to low */
//    *((uint8* const) CDD_MOTOR_PTF_DATA_REG_ADR_UI16 ) &= (uint8)(~((uint8)(0x1U << CDD_MOTOR_NO1_BITPOS_UI8)));  /*lint !e923 */
// #if 0
//    Dio_WriteChannel(DIO_CHANNEL_PU7, DIO_LEVEL_HIGH);
// #endif
 ...
 * \return      ---
 */
// boolean Cdd_Motor_ZD_IsDetectionEnabled (void)
//{
//    return (boolean)cdd_motor_zeroDetectionWindow_t.enabled_ui8;
// }
 ...
 * \return      ---
 */
// uint8 Cdd_Motor_ZD_IsCurrentPositionInZeroWindow (void)
//{
//    uint8 ret_ui8;
//
//    ret_ui8 = (uint8) FALSE;
 ...
 * \return      ---
 */
// uint8 Cdd_Motor_ZD_IsDetectionCompleteAndValid (void)
//{
//    return (uint8)
//           (
//                (cdd_motor_zeroDetectionWindow_t.lastResult_s.windowSize_ui8 != CDD_MOTOR_ZERO_WIDTH_INVALID_UI8)
...
{
	return (uint8)((cdd_motor_zeroDetectionWindow_as[motor_e].lastResult_s.windowSize_ui8 != CDD_MOTOR_ZERO_WIDTH_INVALID_UI8) && (cdd_motor_zeroDetectionWindow_as[motor_e].lastResult_s.windowSizeLeftMiddle_ui8 != CDD_MOTOR_ZERO_WIDTH_INVALID_UI8));
}
...
* \return      0x0 - 0xFE: Distance in microsteps
			   0xFF:       Invalid
*/
// uint8 Cdd_Motor_ZD_GetWindowSize(void)
//{
//    return cdd_motor_zeroDetectionWindow_t.lastResult_s.windowSize_ui8;
// }
...
* \return      0x0 - 0xFE: Distance in microsteps
			   0xFF:       Invalid
*/
// uint8 Cdd_Motor_ZD_GetDistanceZeroPositionAndLeftWindowEdge(void)
//{
//    return cdd_motor_zeroDetectionWindow_t.lastResult_s.windowSizeLeftMiddle_ui8;
// }
...
//{
//    static uint16 isrUsedNbrOfPeriodes_ui16;
//
...
//     */
//    if (cdd_motor_Data_t.isrPeriodeCounter_ui16 > (uint16) 1u) /* c:7,5 */
//    {
//       cdd_motor_Data_t.isrPeriodeCounter_ui16--; /* c:5,5 */
//    }
//    else if (cdd_motor_Data_t.isrPeriodeCounter_ui16 == (uint16) 1u) /* c:7,5 */
//    {
//       cdd_motor_Data_t.isrPeriodeCounter_ui16--; /* c:5,5 */
//
//       /* change step mode if necessary */
//       // TODO: Be aware of speed ramp
//       if ((cdd_motor_Data_t.stepModeChangeReq_e != CDD_MOTOR_STEPMODE_UNDEF)
//                && (cdd_motor_Data_t.currPosLevel0_ui8 == (uint8) 0u))
//       {
//          Cdd_Motor_ChangeStepModeConfig ();
//       }
...
//          {
//             if (cdd_motor_debounceRise_t.ctr_ui8 <= cdd_motor_debouncingThresh_ui8)
//             {
//                if (cdd_motor_debounceRise_t.ctr_ui8 == (uint8)0U)
//                {
//                   /* store second detection point */
//                   cdd_motor_debounceRise_t.posAbsolute_ui32 = cdd_motor_Data_t.currPosLevel1_ui32;
//                   /* store direction */
//                   cdd_motor_debounceRise_t.dir_e = cdd_motor_Data_t.dir_e;
//                }
//
//                cdd_motor_debounceRise_t.ctr_ui8++;
//             }
//             else
//             {
...
//                cdd_motor_debounceFall_t.ctr_ui8 = (uint8) 0U;
//
//                if (CDD_MOTOR_ZERO_DET_STATE_DETECTING_FIRST == cdd_motor_zeroDetectionWindow_t.state_e)
//                {
//                   /* store first detection information */
//                   cdd_motor_zeroDetectionWindow_t.rising_s.pos_ui32 = cdd_motor_debounceRise_t.posAbsolute_ui32;
//                   cdd_motor_zeroDetectionWindow_t.rising_s.dir_e = cdd_motor_debounceRise_t.dir_e;
//                   cdd_motor_zeroDetectionWindow_t.rising_s.valid_ui8 = (uint8) TRUE;
//
//                   cdd_motor_zeroDetectionWindow_t.state_e = CDD_MOTOR_ZERO_DET_STATE_DETECTING_SECOND;
//                }
//                else
//                {
//                   ; /* do nothing */
...
//          else
//          {
//             if (cdd_motor_debounceFall_t.ctr_ui8 <= cdd_motor_debouncingThresh_ui8)
//             {
//                if (cdd_motor_debounceFall_t.ctr_ui8 == (uint8)0U)
//                {
//                   /* store second detection point */
//                   cdd_motor_debounceFall_t.posAbsolute_ui32 = cdd_motor_Data_t.currPosLevel1_ui32;
//                   /* store direction */
//                   cdd_motor_debounceFall_t.dir_e = cdd_motor_Data_t.dir_e;
//                }
//
//                cdd_motor_debounceFall_t.ctr_ui8++;
//             }
//             else
//             {
...
//                cdd_motor_debounceRise_t.ctr_ui8 = (uint8) 0U;
//
//                if (CDD_MOTOR_ZERO_DET_STATE_DETECTING_SECOND == cdd_motor_zeroDetectionWindow_t.state_e)
//                {
//                   /* store second detection information */
//                   cdd_motor_zeroDetectionWindow_t.falling_s.pos_ui32 = cdd_motor_debounceFall_t.posAbsolute_ui32;
//                   cdd_motor_zeroDetectionWindow_t.falling_s.dir_e = cdd_motor_debounceFall_t.dir_e;
//                   cdd_motor_zeroDetectionWindow_t.falling_s.valid_ui8 = (uint8) TRUE;
//
//                   cdd_motor_zeroDetectionWindow_t.state_e = CDD_MOTOR_ZERO_DET_STATE_DETECTION_VALIDATE;
//                }
//                else if (CDD_MOTOR_ZERO_DET_STATE_INITIAL == cdd_motor_zeroDetectionWindow_t.state_e)
//                {
//                   /* Leave initial state ONLY if zero window is INactive */
//                   cdd_motor_zeroDetectionWindow_t.state_e = CDD_MOTOR_ZERO_DET_STATE_DETECTING_FIRST;
//                }
//                else
//                {
//                   ; /* do nothing */
...
//       isrUsedNbrOfPeriodes_ui16 = cdd_motor_Data_t.isrTargetNbrOfPeriodes_ui16; /* c:5,5 */
//       cdd_motor_Data_t.isrPeriodeCounter_ui16 = (uint16) isrUsedNbrOfPeriodes_ui16; /* c:4 */
//       if (cdd_motor_Data_t.currPosLevel1_ui32 == cdd_motor_Data_t.trgtPosLevel1_ui32) /* c:8,5 */
//       {
//          cdd_motor_Data_t.isrIsRunning_ui8 = (uint8) FALSE;
...
//       else
//       {
//          if (cdd_motor_Data_t.dir_e == CDD_MOTOR_DIR_FORWARD) /* c:5,5 */
//          {
//             if (cdd_motor_Data_t.currPosLevel1_ui32 >= (Cdd_Motor_Cfg_t.uStepMaximumAbsolute_ui32 - (uint32)1uL)) /* c:6 */
//             {
//                cdd_motor_Data_t.currPosLevel1_ui32 = 0; /* c:4 */
//             }
//             else
//             {
//                cdd_motor_Data_t.currPosLevel1_ui32++; /* c:5,5 */
//             }
//
//             if (cdd_motor_Data_t.currPosLevel0_ui8 >= (CDD_MOTOR_MICRO_STEPS_ARRAY_SIZE - (uint8)1u))
//             {
//                cdd_motor_Data_t.currPosLevel0_ui8 = (uint8)0u;
//             }
//             else
//             {
//                cdd_motor_Data_t.currPosLevel0_ui8++;
//             }
//          }
//          else
//          {
//             if (cdd_motor_Data_t.currPosLevel1_ui32 == (uint32) 0uL)
//             {
//                cdd_motor_Data_t.currPosLevel1_ui32 = (Cdd_Motor_Cfg_t.uStepMaximumAbsolute_ui32 - (uint32) 1uL);
//             }
//             else
//             {
//                cdd_motor_Data_t.currPosLevel1_ui32--;
//             }
//
//             if (cdd_motor_Data_t.currPosLevel0_ui8 == (uint8)0u)
//             {
//                cdd_motor_Data_t.currPosLevel0_ui8 = (uint8)CDD_MOTOR_MICRO_STEPS_ARRAY_SIZE - (uint8)1u;
//             }
//             else
//             {
//                cdd_motor_Data_t.currPosLevel0_ui8--;
...
//          }
// #if 0
//          coilIndex_ui16 = (uint16) (cdd_motor_Data_t.currPosLevel1_ui32 % (uint32) CDD_MOTOR_MICRO_STEPS_ARRAY_SIZE); /* c:13 */
// #endif
//          /* THIS SEQUENCE MAY NOT BE INTERRUPTED ********************************** */
//          DISABLE_ALL_INTERRUPTS(); /*lint !e960 */
//          /* Set duty cycle ********************************************************************* */
//          CDD_MOTOR_SET_DUTYCYCLE_COIL0(cdd_motor_Data_t.usedPatternCoil_0_ui16[cdd_motor_Data_t.currPosLevel0_ui8]); /* c:8 */
//          CDD_MOTOR_SET_DUTYCYCLE_COIL1(cdd_motor_Data_t.usedPatternCoil_1_ui16[cdd_motor_Data_t.currPosLevel0_ui8]); /* c:8 */
//          ENABLE_ALL_INTERRUPTS(); /*lint !e960 */
//          /* END OF UNINTERRUPTABLE SEQUENCE *************************************** */
//       } /* 4 */
//    }
...
boolean Cdd_Motor_RunMotorISR_HHSS(void)
{
		...
		if (cdd_motor_zeroDetectionWindow_as[CDD_MOTOR_MTR_HHSS].enabled_ui8 == (uint8)TRUE)
		{
			...
			else
			{
				if (cdd_motor_debounceFall_as[CDD_MOTOR_MTR_HHSS].ctr_ui8 <= cdd_motor_debouncingThresh_ui8)
				{
					...
					{
						/* store second detection point */
						cdd_motor_debounceFall_as[CDD_MOTOR_MTR_HHSS].posAbsolute_ui32 = cdd_motor_Data_as[CDD_MOTOR_MTR_HHSS].currPosLevel1_ui32;
						/* store direction */
						cdd_motor_debounceFall_as[CDD_MOTOR_MTR_HHSS].dir_e = cdd_motor_Data_as[CDD_MOTOR_MTR_HHSS].dir_e;
					}
	...
	else /* c:7,5 */
	{
		...
		if (cdd_motor_Data_as[CDD_MOTOR_MTR_HHSS].currPosLevel1_ui32 == cdd_motor_Data_as[CDD_MOTOR_MTR_HHSS].trgtPosLevel1_ui32) /* c:8,5 */
		{
...
boolean Cdd_Motor_RunMotorISR_MM(void)
	...
	else /* c:7,5 */
	{
		...
		cdd_motor_Data_as[CDD_MOTOR_MTR_MM].isrPeriodeCounter_ui16 = (uint16)isrUsedNbrOfPeriodes_ui16_MM; /* c:4 */
