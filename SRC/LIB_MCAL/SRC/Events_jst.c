...
{	
	flags.Bits.R_RX_CHAR = 1;	 /* Set the "RX" flag */
...
//		if (0x7A == command) {
//			//CPMUARMCOP = 0x01U;
//			Wdg_SetCpmuArmCopArmCop(0x01); 
//			
//			//CPMUARMCOP = 0x10U;
//			Wdg_SetCpmuArmCopArmCop(0x10);
//		}
//	} else {
//		uint8 data;
//		IIC0_RecvChar(&data);
